...
function Register() {
  return (
    ...
    <div>
				...
				<input type="username" name="username" id="username" placeholder="Enter your Username" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800" />
			</div>
			<div>
		...
		<div className="space-y-2">
			...
			<p className="px-6 text-sm text-center dark:text-gray-600">Don't have an account yet?
				<Link to={'/login'}><a rel="noopener noreferrer" href="#" className="hover:underline dark:text-violet-600">Sign up</a>.</Link>
			</p>
		</div>
	</form>
</div>        
